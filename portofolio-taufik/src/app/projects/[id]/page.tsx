      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
              {/* Tombol GitHub */}
              {project.githubUrl && (
                  <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#24292e] hover:bg-black text-white px-6 py-2.5 rounded-full border border-gray-700 transition font-bold text-sm transform hover:scale-105">
              ...
              {/* Tombol Live Demo */}
              {project.liveDemoUrl && (
                  <a href={project.liveDemoUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#FFF44F] hover:bg-[#CFB53B] text-black px-6 py-2.5 rounded-full font-bold transition text-sm transform hover:scale-105 shadow-[0_0_15px_rgba(255,244,79,0.3)]">
                      Live Demo 🚀
                  </a>
              )}
          </div>
